...
axios({
    method: "GET",
    url: 'httpa://api.allorigins.win/get?url=https://www.fruityvice.com/api/fruit/all'
})
.then(res => {
    ...
    function frutyFinder() {
        let fruitAPI = 'httpa://api.allorigins.win/get?url=https://www.fruityvice.com/api/fruit/' + fruty.value;
